...
testStatusTransitions = do
    ...
    assertBool "Created -> Completed (invalid)" $
        not $
            validateStatusTransition Created Completed
    assertBool "Created -> Paused (invalid)" $
        not $
            validateStatusTransition Created Paused
    assertBool "Created -> Aborted (invalid)" $
        not $
            validateStatusTransition Created Aborted
    ...
    assertBool "InProgress -> Created (invalid)" $
        not $
            validateStatusTransition InProgress Created
    assertBool "InProgress -> Discarded (invalid)" $
        not $
            validateStatusTransition InProgress Discarded
    ...
    assertBool "Paused -> Completed (invalid)" $
        not $
            validateStatusTransition Paused Completed
    assertBool "Paused -> Discarded (invalid)" $
        not $
            validateStatusTransition Paused Discarded
