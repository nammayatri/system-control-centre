...
listReleaseTrackers = withCloudDb $ \cloud db -> do
    rows <-
        runDB db $
            runSelectReturningList $
                select $
...
listReleaseTrackersByDateRangeAndCategory fromTime toTime mCategoryWhitelist = withCloudDb $ \cloud db -> do
    rows <-
        runDB db $
            runSelectReturningList $
                select $
...
findCleanupScheduledTrackers now = withCloudDb $ \cloud db -> do
    rows <-
        runDB db $
            runSelectReturningList $
                select $
...
findTrackersWithStatusAndTime statusList ts = withCloudDb $ \cloud db -> do
    rows <-
        runDB db $
            runSelectReturningList $
                select $
...
findReleaseTrackersByCategory cat from to = withCloudDb $ \cloud db -> do
    rows <-
        runDB db $
            runSelectReturningList $
                select $
