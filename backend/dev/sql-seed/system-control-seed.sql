...
-- Outbound release webhooks, scoped like deployment_config.
-- services holds a JSON array of service names; NULL/[] = every service in the
-- app group. headers/query_params hold a JSON array of {"key":..,"value":..}.
...
-- Exactly-once guard for the webhook dispatcher's claim marker.
